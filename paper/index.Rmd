...
# remove templates and auto-delineate 
fpp_tem <- auto_delin(f, replace = TRUE)
```

```{r auto-delin, fig.cap="Delineation templates: (A) manual delineations using the FRL template and (B) automatic delineations using the 74-point automatic template.", fig.alt="Five different West Asian female faces showing a 189-point template marking the full face (top row) and a reduced 74-point template marking only the jaw from ear to ear and internal facial features (bottom row)."}
