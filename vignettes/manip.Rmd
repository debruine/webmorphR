...
lisa <- load_stim_lisa()
lisa_horiz <- horiz_eyes(lisa, fill = patch(lisa))
...
stimuli |>
  align(x1 = 350, y1 = 350, x2 = 450, y2 = 450,
        width = 800, height = 800, fill = patch(stimuli)) |>
  plot()
```
...
aligned3 <- align(lisa, ref_img = "lisa3", fill = patch(lisa)) 
...
align(lisa, procrustes = TRUE, fill = patch(lisa)) |>
  plot()
```
