...
The auto-delineation has three options. The default is "dlib7", which is a 7-point template (tip of the nose, corners of the eyes, and their midpoints) and works without access to external services.

I'm working on ways to add "dlib70", a 70-point template (68 plus 2 added centre eye points) used by [dlib](https://ibug.doc.ic.ac.uk/resources/facial-point-annotations/). This file is big (~100MB) and it's tricky to include on github or CRAN. Currently, you can add this file (named "dlib70.dat") yourself to the folder at:
...
# now you should see dlib70.dat in this list
list.files(python_dir)
```
...
Let's start with a set of images from the demo image sets. You need to have the [stimsets](https://github.com/debruine/stimsets) package installed if you haven't done that already.
